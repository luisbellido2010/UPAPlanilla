...
try {
    ...
    $pro = new dUsuario();
    $pro->dActualizarUsuario($codiusua, $clavusua, $aliausua, $statusua);
    //dInsertarUsuario($codiusua, $nocousua, $clavusua, $aliausua, $codipers, $statusua);
    if ($pro->getStmt()) {
        echo json_encode(array('okMsg' => 'Usuario actualizado correctamente'));
    } else {
